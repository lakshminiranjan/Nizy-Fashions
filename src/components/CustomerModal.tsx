          ...
          <form onSubmit={handleSubmit} className="bg-white">
            ...
            <div className="px-4 py-5 sm:p-6">
              <div className="space-y-4">
                ...
                <div>
                  <label htmlFor="other_measurements" className="block text-sm font-medium text-gray-700">
                    Other Measurements
                  </label>
                  <textarea
                    id="other_measurements"
                    rows={3}
                    value={formData.other_measurements || ''}
                    onChange={(e) => setFormData({ ...formData, other_measurements: e.target.value })}
                    className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                    placeholder="e.g., Shoulder: 18in, Neck: 16in"
                  />
                  <p className="mt-1 text-sm text-gray-500">
                    Add any additional measurements or notes here
                  </p>
                </div>
              </div>
            </div>
